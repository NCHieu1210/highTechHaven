...
const DeleteRangeCategories = (props) => {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      const response = await deleteRangeCategoriesService(selectedRowKeys);
      if (response.success) {
  ...
  return (
    <>
      ...
      <Popconfirm
        title={`Xóa ${selectedRowKeys.length} danh mục!`}
...
export default DeleteRangeCategories;